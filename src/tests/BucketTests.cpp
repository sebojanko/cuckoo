...
void test_Bucket__InsertedOneElement__RetrievesFirstWithOverloadedOperator() {
    Bucket b = Bucket();
    b.Push("test");
    assert(b[0] == "test");
    std::cout << "PASS test_Bucket__InsertedOneElement__RetrievesFirst" << std::endl;
...
void test_Bucket__InsertedFiveElements__RetrievesLastWithOverloadedOperator() {
    Bucket b = Bucket();
    b.Push("1");
    b.Push("2");
    b.Push("3");
...
void test_Bucket__InsertedFiveElements__RetrievesThirdWithOverloadedOperator() {
    Bucket b = Bucket();
    b.Push("1");
    b.Push("1");
    b.Push("1");
...
void test_Bucket__InsertedTwoElements__FailsToRetrieveThirdWithOverloadedOperator() {
    Bucket b = Bucket();
    b.Push("1");
    b.Push("2");
    assert(b[2] != "2");
...
void test_Bucket__InsertedTwoElements__FailsToRetrieveMinusFirstWithOverloadedOperator() {
    Bucket b = Bucket();
    b.Push("1");
    b.Push("2");
    assert(b[-1] != "2");
